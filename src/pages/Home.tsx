...
const Home = () => {
  ...
  const processSteps = [
    ...
    },
    {
      ...
      desc: { fr: 'Votre moustiquaire est fabriquée selon vos mesures exactes avec les matériaux Grifo Flex.', ar: 'مستيكارتكم تُصنع وفق قياساتكم الدقيقة بمواد Grifo Flex.', tn: 'مستيكاركم تتصنع حسب قياساتكم الدقيقة.', en: 'Your screen is made to your exact measurements with Grifo Flex materials.', it: 'La vostra zanzariera è prodotta sulle vostre misure esatte.' },
    },
    {
      icon: ShieldCheck,
      num: '03',
